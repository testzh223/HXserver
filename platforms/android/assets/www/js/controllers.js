angular.module('HXControllers', ['HXServices', 'firebase', 'ionic'])
    ...
    .controller('friendCtrl', function ($scope, $rootScope,myHttp) {
        ...
        $scope.openChat = function (x) {
            ...
            var arr = $rootScope.HXUI.chats[x.Account];
            arr.push({From:'1',Text:'2234532534653647546765555555555555555555534855444444444444444444',Update:new Date().getTime()});
            arr.push({From:'2',Text:'2234532534653647546765555555555555555555534855444444444444444444',Update:new Date().getTime()});
            arr.push({From:'2',Text:'2234532534653647546765555555555555555555534855444444444444444444',Update:new Date().getTime()});
            arr.push({From:'1',Text:'2234532534653647546765555555555555555555534855444444444444444444',Update:new Date().getTime()});
            arr.push({From:'1',Text:'2234532534653647546765555555555555555555534855444444444444444444',Update:new Date().getTime()});
            arr.push({From:'2',Text:'2234532534653647546765555555555555555555534855444444444444444444',Update:new Date().getTime()});
